        ...
        * {
        ...
        body {
            ...
            background:
                    ...
                    linear-gradient(135deg, #f8fbff 0%, #eef7ff 45%, #dff2ff 100%);
            color: #0f172a;
        }
        ...
        .packing-hero {
            ...
            color: #0f172a;
            background:
                    radial-gradient(circle at 92% 10%, rgba(14, 165, 233, 0.24), transparent 34%),
                    linear-gradient(135deg, #ffffff 0%, #eef7ff 48%, #e0f2fe 100%);
        ...
        .upload-guide {
            ...
            padding: 18px 20px;
            background:
                    linear-gradient(135deg, rgba(16, 185, 129, 0.13), rgba(14, 165, 233, 0.10)),
                    #f0fdf4;
            color: #064e3b;
        ...
        .summary-card {
            ...
            background:
                    radial-gradient(circle at 90% 5%, rgba(14, 165, 233, 0.20), transparent 35%),
    ...
    <div class="packing-page">
        ...
        <div class="packing-hero">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="hero-badge">PACKING ORDER</div>
                    <h1 class="packing-title">포장 지시 등록</h1>
                    <p class="packing-subtitle">
        ...
        <div class="card packing-card">
            <div class="card-body">
                ...
                <form id="packingOrderForm"
                      method="post"
                      action="${pageContext.request.contextPath}/admin/packing/save"
                      novalidate>

                    <div class="row g-3 mb-3 section-panel">
                        <div class="col-md-6">
                            <div class="section-title">입력 방식</div>
                            <div class="d-flex gap-2 flex-wrap mode-button-wrap">
                            ...
                            <div class="form-text">
                                수기 입력 또는 엑셀 일괄 등록으로 포장 지시 항목을 추가할 수 있습니다.
                            </div>
                        </div>
                    ...
                    <div class="list-head">
                        <h6 class="list-title">포장 지시 목록</h6>
                    ...
                    <div class="row g-3 bottom-panel">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="포장팀" readonly>
                        </div>
                        <div class="col-md-4">
        ...
        <script>
            (function () {
                ...
                const form = document.getElementById('packingOrderForm');
                ...
                function renderTable() {
                    ...
                    if (detailList.length === 0) {
                        ...
                        td.textContent = '추가된 포장 지시 항목이 없습니다.';
                        tr.appendChild(td);
